...
function Hero() {
    ...
    return (
        <div className="flex overflow-hidden flex-col items-center justify-center py-10 h-125 w-full max-md:max-w-full bg-[url('/images/default-hero.png')] bg-cover bg-center">
            ...
            <h2 className='text-6xl font-semibold text-center text-[#31487A] mt-16'>{t('title')} </h2>
            <p className='text-[#31487A] px-3 lg:px-80 text-center my-6 font-medium text-xl'>{t('prev')}</p>
