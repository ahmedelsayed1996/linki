...
function AboutUsPage() {
    return (
        <>
            <Hero />
            {/* first section */}
            <div className='flex flex-col lg:flex-row gap-5 p-5 lg:p-16'>
                <div className='lg:w-1/2 '>
                    <h2 className='text-4xl font-semibold text-start text-[#31487A] mt-16 lg:pe-24'>Our goal is to empower the healthcare sector through smart and reliable supply.</h2>
                    <p className='text-[#31487A] text-start mt-6 lg:text-lg'>Linki Marketplace was launched with a clear vision to transform the process of sourcing medical equipment into a seamless and efficient digital experience.</p> <br />
                    <p className='text-[#31487A] text-start  lg:text-lg mb-6'>We connect trusted medical suppliers with hospitals, centers, and clinics to simplify purchasing and deliver smart solutions that enhance the quality of healthcare services across the region.</p>
            ...
            {/* our Mission */}
            <div className='flex flex-col lg:flex-row gap-5 p-5 lg:p-16 lg:pb-5'>
            ...
            {/* our Vision */}
            <div className='flex flex-col lg:flex-row gap-5 p-5 lg:p-16 lg:pt-0'>
            ...
            <div className='flex flex-col lg:flex-row gap-5 p-5 lg:p-16'>
                ...
                <div className='lg:w-1/2'>
                    <h2 className='text-4xl font-semibold text-start text-[#31487A] mt-16 lg:pe-24'>What We Offer</h2>
            ...
            <div className='bg-[#F1F8FE] p-5 lg:p-16'>
                ...
                <p className='text-[#31487A] text-center mt-6 text-lg px-6 lg:px-64'>The Linki team brings together top professionals from the fields of technology and healthcare, working hand in hand to redefine the medical supply experience — making it smarter, faster, and more reliable.</p>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-4 gap-4 mt-10'>
                    <div className='bg-white rounded-lg flex flex-col justify-center items-center '>
                        ...
                        <h3 className='text-[#31487A] font-medium text-xl'>Dr/ Mohamed El-Faraby </h3>
                        <p>CTO</p>
                    </div>
                    <div className='bg-white rounded-lg flex flex-col justify-center items-center '>
                        <Image src="/images/avatar.jpeg" alt="Hero" width={200} height={100} objectFit=" object-cover rounded-lg" />
                        <h3 className='text-[#31487A] font-medium text-xl'>Eng./ Omar Eissa </h3>
                        <p>CTO</p>
                    </div>
                    <div className='bg-white rounded-lg flex flex-col justify-center items-center '>
                        <Image src="/images/avatar.jpeg" alt="Hero" width={200} height={100} objectFit=" object-cover rounded-lg" />
                        <h3 className='text-[#31487A] font-medium text-xl'>Eng./ Mohamed Alaa </h3>
                        <p>Technical Lead</p>
                    </div>
                    <div className='bg-white rounded-lg flex flex-col justify-center items-center '>
                        <Image src="/images/avatar.jpeg" alt="Hero" width={200} height={100} objectFit=" object-cover rounded-lg" />
                        <h3 className='text-[#31487A] font-medium text-xl'>Mr./ Hossam Farouk</h3>
                        <p>Sales Manager</p>
                    </div>
                </div>
            </div>
